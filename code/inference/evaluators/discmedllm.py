...
class DISCMedLLMEvaluator(Evaluator):
    ...
    def __init__(self, pretrained_model_name_or_path, cache_dir=None, do_sample=False):
        ...
        self.model.generation_config = GenerationConfig.from_pretrained(pretrained_model_name=pretrained_model_name_or_path)
